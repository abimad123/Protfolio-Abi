    ...
    window.addEventListener('load', () => {
        checkScroll(); // Show any sections already in view
        document.querySelector('.hero').classList.add('visible'); // Show hero immediately
    });



    // Check on scroll
    window.addEventListener('scroll', checkScroll); // Typing Effect for Logo
    document.addEventListener("DOMContentLoaded", function() {
